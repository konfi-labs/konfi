...
/**
 * Builds and executes requests for operations under /sale/offer-price-change-commands/{commandId}/tasks
 */
 ...
 */
export const TasksRequestBuilderUriTemplate = "{+baseurl}/sale/offer-price-change-commands/{commandId}/tasks{?limit*,offset*}";
/**
