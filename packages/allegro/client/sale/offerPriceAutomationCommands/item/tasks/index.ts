...
/**
 * Builds and executes requests for operations under /sale/offer-price-automation-commands/{commandId}/tasks
 */
 ...
 */
export const TasksRequestBuilderUriTemplate = "{+baseurl}/sale/offer-price-automation-commands/{commandId}/tasks{?limit*,offset*}";
/**
