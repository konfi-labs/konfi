...
/**
 * Builds and executes requests for operations under /sale/offer-publication-commands/{commandId}/tasks
 */
 ...
 */
export const TasksRequestBuilderUriTemplate = "{+baseurl}/sale/offer-publication-commands/{commandId}/tasks{?limit*,offset*}";
/**
