...
export interface ComputeActionContext extends Record<string, unknown> {
  ...
  /**
   * The channel the cart belongs to.
   */
  channelId?: string;

  /**
   * The customer's reusable segmentation groups.
   */
  ...
  /**
   * Number of times the relevant promotion has already been used in context.
   */
  usageCount?: number;
   ...
   */
  shippingMethods?: ComputeActionShippingLine[];
}
