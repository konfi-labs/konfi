...
/**
 * Instantiates a new {@link EpakaClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createEpakaClient(requestAdapter: RequestAdapter) {
    ...
    if (requestAdapter.baseUrl === undefined || requestAdapter.baseUrl === null || requestAdapter.baseUrl === "") {
        requestAdapter.baseUrl = "https://api.epaka.pl";
    }
    const pathParameters: Record<string, unknown> = {
        "baseurl": requestAdapter.baseUrl,
    };
    return apiClientProxifier<EpakaClient>(requestAdapter, pathParameters, EpakaClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface EpakaClient extends BaseRequestBuilder<EpakaClient> {
    /**
     * The oauth property
     */
 ...
 */
export const EpakaClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const EpakaClientNavigationMetadata: Record<Exclude<keyof EpakaClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    oauth: {
