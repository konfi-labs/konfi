...
const config = {
  apiKey: process.env.NEXT_PUBLIC_FIREBASE_STORE_API_KEY || "demo-api-key",
  authDomain:
  ...
  appId:
    process.env.NEXT_PUBLIC_FIREBASE_STORE_APP_ID ||
    "1:000000000000:web:0000000000000000000000",
  measurementId:
    process.env.NEXT_PUBLIC_FIREBASE_STORE_MEASUREMENT_ID || "G-XXXXXXXXXX",
};
